...
function generateFromTransaction(amount) {
...
function parseExpenseText(text) {
  ...
  const datePatterns = [
    ...
    {
      pattern: /\b(monday)\b/gi,
      day: 1
    },
    {
      pattern: /\b(tuesday)\b/gi,
      day: 2
    },
    {
      pattern: /\b(wednesday)\b/gi,
      day: 3
    },
    {
      pattern: /\b(thursday)\b/gi,
      day: 4
    },
    {
      pattern: /\b(friday)\b/gi,
      day: 5
    },
    {
      pattern: /\b(saturday)\b/gi,
      day: 6
    },
    {
      pattern: /\b(sunday)\b/gi,
      day: 0
    }
  ];
